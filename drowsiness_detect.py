...
# Minimum consecutive frames for which eye ratio is below threshold for
...
while(True):
    ...
    for face in faces:
        ...
        # Use hull to remove convex contour discrepencies and draw eye shape
        # around eyes
        ...
        if(eyeAspectRatio < EYE_ASPECT_RATIO_THRESHOLD):
            ...
            if COUNTER >= EYE_ASPECT_RATIO_CONSEC_FRAMES:
                ...
                cv2.putText(frame, "EYES ARE CLOSED!", (270, 30),
        ...
        # Check if the person is yawning
            if MAR > MAR_THRESHOLD:
                ...
                if count_yawn >= MOUTH_ASPECT_RATIO_CONSEC_FRAMES:
                    pygame.mixer.music.play(-1)
